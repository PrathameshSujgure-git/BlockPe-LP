  ...
  return (
    ...
    <div className="min-h-screen text-[#f6f3ea] overflow-x-clip font-['DM_Sans',sans-serif]">
      ...
      <div className="relative z-10 bg-[#0a0b0d]">
        <Navbar />
        {/* Left/right border lines — construction lines */}
        <div className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[390px] lg:max-w-[1200px] h-full z-40">
